<%-- 
    ...
    Created on : 2 Jun 2026, 3:10:46 pm
        ...
        <div class="row">
            <div class="container">
                ...
                <div class="container text-left">
                    <a href="<%=request.getContextPath()%>/?action=new"
                           ...
                           <tbody>
                               <c:forEach var="employee"
                                   ...
                                   <tr>
                                       ...
                                       <td>
                                           <a href="<%=request.getContextPath()%>/?action=edit&id=<c:out value='${employee.id}' />">Edit</a>
                                           &nbsp;&nbsp;&nbsp;&nbsp;
                                           <a href="<%=request.getContextPath()%>/?action=delete&id=<c:out value='${employee.id}' />">Delete</a>
                                       </td>
                                   </tr>
                               </c:forEach>
                           </tbody>
